...
### Added
- **Saved Search Trigger (Polling)**: Added a dedicated Close CRM trigger that executes the saved search's query and emits leads when they enter its result set. A lead that leaves and later re-enters triggers again.
